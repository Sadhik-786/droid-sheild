...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initPresets() {
        ...
        const presetMapping = {
            "com.android.vending": { icon: "shopping_bag", colorClass: "bg-primary/10 text-primary", category: "SYSTEM" },
            "com.whatsapp": { icon: "chat", colorClass: "bg-secondary/10 text-secondary", category: "SOCIAL" },
            "com.instagram.android": { icon: "photo_camera", colorClass: "bg-secondary/10 text-secondary", category: "SOCIAL" },
            "com.snapchat.android": { icon: "sentiment_satisfied", colorClass: "bg-secondary/10 text-secondary", category: "SOCIAL" },
            "org.telegram.messenger": { icon: "send", colorClass: "bg-secondary/10 text-secondary", category: "SOCIAL" },
            "com.instagram.barcelona": { icon: "alternate_email", colorClass: "bg-secondary/10 text-secondary", category: "SOCIAL" },
            "com.utorrent.client": { icon: "download", colorClass: "bg-primary/10 text-primary", category: "UTILITY" },
            "com.crypto.miner": { icon: "monetization_on", colorClass: "bg-error/10 text-error", category: "MALWARE" },
            "com.sms.covert.service": { icon: "sms", colorClass: "bg-error/10 text-error", category: "MALWARE" },
            "com.data.harvest.pro": { icon: "security_update_warning", colorClass: "bg-error/10 text-error", category: "MALWARE" }
        };
